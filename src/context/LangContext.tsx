...
const translations: Translations = {
  en: {
    ...
    'auth.errAccessDenied': 'Sign-in was refused. Please contact an administrator if you believe this is a mistake.',
    'auth.errAccountExists': 'An account with this email already exists using a different sign-in method. Sign in with your email and password instead.',
    ...
    'att.tabRecord': 'Record Attendance',
    'att.tabView': 'View Attendance',
    'att.range': 'Time Range',
    'att.months1': '1 Month',
    'att.months2': '2 Months',
    'att.months3': '3 Months',
    'att.months4': '4 Months',
    'att.rate': 'Rate',
    'att.noHistory': 'No attendance recorded in this period.',
    'att.noMeetingDay': 'No meeting day set for this house church.',
    'att.selectHc': 'Select a house church',
  ...
  es: {
    ...
    'auth.errAccessDenied': 'Se rechazó el inicio de sesión. Contacta a un administrador si crees que es un error.',
    'auth.errAccountExists': 'Ya existe una cuenta con este correo usando otro método de inicio de sesión. Inicia sesión con tu correo y contraseña.',
    'auth.errGeneric': 'Error al iniciar sesión. Inténtalo de nuevo.',
    ...
    'att.tabRecord': 'Registrar Asistencia',
    'att.tabView': 'Ver Asistencia',
    'att.range': 'Período',
    'att.months1': '1 Mes',
    'att.months2': '2 Meses',
    'att.months3': '3 Meses',
    'att.months4': '4 Meses',
    'att.rate': 'Tasa',
    'att.noHistory': 'No se registró asistencia en este período.',
    'att.noMeetingDay': 'No hay día de reunión configurado para esta iglesia en casa.',
    'att.selectHc': 'Selecciona una iglesia en casa',
