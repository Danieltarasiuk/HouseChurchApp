...
const translations: Translations = {
  en: {
    ...
    'settings.adminOnly': 'Only Senior Pastors can manage user roles and permissions.',
    'settings.you': 'You',
    'role.admin': 'Admin',
  },
  es: {
    ...
    'hc.role': 'Rol',
    'common.name': 'Nombre',
    'role.senior_pastor': 'Pastor Principal',
    ...
    'settings.adminOnly': 'Solo los Pastores Principales pueden administrar roles y permisos.',
    'settings.you': 'Tú',
